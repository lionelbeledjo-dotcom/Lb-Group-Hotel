...
<body style="font-family: 'Segoe UI', Arial, sans-serif; padding: 30px; background: #f8f9fc; color: #1a2744;">
  <div style="max-width: 560px; margin: 0 auto; background: #fff; border-radius: 12px; padding: 32px; box-shadow: 0 2px 12px rgba(0,0,0,0.06);">
    <div style="text-align: center; margin-bottom: 24px; border-bottom: 3px solid #1a2744; padding-bottom: 16px;">
      <h1 style="font-size: 22px; margin: 0;">📩 Nouveau message de contact</h1>
      <p style="color: #666; font-size: 12px; margin-top: 4px;">LB Group — Notification instantanée</p>
    </div>

    <table style="width: 100%; border-collapse: collapse;">
      <tr style="border-bottom: 1px solid #eee;">
        <td style="padding: 10px 0; font-weight: 600; width: 100px;">De</td>
      ...
      <tr style="border-bottom: 1px solid #eee;">
        <td style="padding: 10px 0; font-weight: 600;">Sujet</td>
    ...
    <div style="margin-top: 24px; text-align: center;">
      <a href="mailto:${email}?subject=Re: ${subject || "Votre message"}" style="display: inline-block; padding: 12px 28px; background: linear-gradient(135deg, #1a2744, #2a3f6e); color: #fff; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 14px;">
        Répondre
      </a>
    </div>
    ...
    if (RESEND_API_KEY) {
      ...
      console.log("RESEND_API_KEY not set — contact email skipped:", { name, email, subject });
    }
